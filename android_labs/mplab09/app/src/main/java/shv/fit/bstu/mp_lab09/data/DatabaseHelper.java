package shv.fit.bstu.mp_lab09.data;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "database9.db";
    ...
    public ArrayList<ContactModal> getAllUsers(){
    ...
    public void addNewData(ContactModal newData){
        SQLiteDatabase db = open();
    ...
    public void updateData(ContactModal data){
        SQLiteDatabase db = open();
